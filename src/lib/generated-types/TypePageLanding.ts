...
export interface TypePageLandingFields {
    ...
    sections: EntryFieldTypes.Array<EntryFieldTypes.EntryLink<TypeBannerCarouselSkeleton | TypeBannerSkeleton | TypeCallToActionSkeleton | TypeCardsWithFormSkeleton | TypeFooterSkeleton | TypeFormSkeleton | TypeGallerySkeleton | TypeHeaderSkeleton | TypeHeroImageSkeleton | TypeSetOfCardSkeleton | TypeSetOfTestimonialsSkeleton>>;
}
